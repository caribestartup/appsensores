...
<div class="kyp-menu">
  ...
  <img id="menu-img-back" src="<?= Url::to('res/menu.png')?>">
	...
	<div class="row menu-container nav-showed">
      ...
      <div>
          <a href="<?= Url::toRoute('site/index')?>"><img class="img-menu-item" src="<?= Url::to('res/icon_home.png')?>"></a>
          <a href="<?= Url::toRoute('local/index')?>"><img class="img-menu-item" src="<?= Url::to('res/icon_map.png')?>"></a>
          <a href="<?= Url::toRoute('/maquina/charts')?>"><img class="img-menu-item" src="<?= Url::to('res/icon_charts.png')?>"></a>
          <a href="<?= Url::toRoute('site/index')?>"><img class="img-menu-item" src="<?= Url::to('res/icon_proccess.png')?>"></a>
      </div>
		</div>
